 ...
 * Only validates ACCESS tokens — refresh tokens are handled exclusively by AuthController.
 */
@Slf4j
@Component
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            // Only proceed if username extracted and no existing authentication
            ...
            // Do not rethrow — let the request continue unauthenticated;
